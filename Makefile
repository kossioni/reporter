...
SRC:=$(GOPATH)/src/github.com/kossioni/reporter
...
.PHONY: build
build: 
	go install -v github.com/kossioni/reporter/cmd/grafana-reporter@latest

.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/kossioni/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t kossioni/grafana-reporter:2.3.0 -t kossioni/grafana-reporter:latest .

docker-push:
	@docker push kossioni/grafana-reporter
